...
Note from the author: Yeah, this was generated by Mistral Vibe, but I did want to see how different models and quantizations work in my hardware. I explicitly asked for these to be measured. Results in seconds were measured and timed.
